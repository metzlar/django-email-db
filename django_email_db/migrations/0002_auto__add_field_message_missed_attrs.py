...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Message.missed_attrs'
        db.add_column(u'django_email_db_message', 'missed_attrs',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Message.missed_attrs'
        db.delete_column(u'django_email_db_message', 'missed_attrs')
